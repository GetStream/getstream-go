...
// This event is sent when a user is blocked on a call, clients can use this event to show a notification.
// If the blocked user is the current user, the client should leave the call screen as well
...
// This event is sent to all watchers of the call when a call is created.
