...
type OwnCapabilityType string

const (
	OwnCapabilityBLOCK_USERS               OwnCapabilityType = "block-users"
	OwnCapabilityCREATE_CALL               OwnCapabilityType = "create-call"
	OwnCapabilityCREATE_REACTION           OwnCapabilityType = "create-reaction"
	OwnCapabilityENABLE_NOISE_CANCELLATION OwnCapabilityType = "enable-noise-cancellation"
	OwnCapabilityEND_CALL                  OwnCapabilityType = "end-call"
	OwnCapabilityJOIN_BACKSTAGE            OwnCapabilityType = "join-backstage"
	OwnCapabilityJOIN_CALL                 OwnCapabilityType = "join-call"
	OwnCapabilityJOIN_ENDED_CALL           OwnCapabilityType = "join-ended-call"
	OwnCapabilityMUTE_USERS                OwnCapabilityType = "mute-users"
	OwnCapabilityPIN_FOR_EVERYONE          OwnCapabilityType = "pin-for-everyone"
	OwnCapabilityREAD_CALL                 OwnCapabilityType = "read-call"
	OwnCapabilityREMOVE_CALL_MEMBER        OwnCapabilityType = "remove-call-member"
	OwnCapabilitySCREENSHARE               OwnCapabilityType = "screenshare"
	OwnCapabilitySEND_AUDIO                OwnCapabilityType = "send-audio"
	OwnCapabilitySEND_VIDEO                OwnCapabilityType = "send-video"
	OwnCapabilitySTART_BROADCAST_CALL      OwnCapabilityType = "start-broadcast-call"
	OwnCapabilitySTART_RECORD_CALL         OwnCapabilityType = "start-record-call"
	OwnCapabilitySTART_TRANSCRIPTION_CALL  OwnCapabilityType = "start-transcription-call"
	OwnCapabilitySTOP_BROADCAST_CALL       OwnCapabilityType = "stop-broadcast-call"
	OwnCapabilitySTOP_RECORD_CALL          OwnCapabilityType = "stop-record-call"
	OwnCapabilitySTOP_TRANSCRIPTION_CALL   OwnCapabilityType = "stop-transcription-call"
	OwnCapabilityUPDATE_CALL               OwnCapabilityType = "update-call"
	OwnCapabilityUPDATE_CALL_MEMBER        OwnCapabilityType = "update-call-member"
	OwnCapabilityUPDATE_CALL_PERMISSIONS   OwnCapabilityType = "update-call-permissions"
	OwnCapabilityUPDATE_CALL_SETTINGS      OwnCapabilityType = "update-call-settings"
)
