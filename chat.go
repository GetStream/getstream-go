...
func (c *ChatClient) GetOrCreateDistinctChannel(ctx context.Context, Type string, ChannelGetOrCreateRequest ChannelGetOrCreateRequest) (ChannelStateResponse, error) {
	...
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/channels/{type}/query", nil, &ChannelGetOrCreateRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) DeleteChannel(ctx context.Context, Type string, Id string, HardDelete *bool) (DeleteChannelResponse, error) {
	...
	err := MakeRequest[any](c.client, ctx, "DELETE", "/api/v2/chat/channels/{type}/{id}", url.Values{"HardDelete": []string{HardDelete}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) UpdateChannelPartial(ctx context.Context, Type string, Id string, UpdateChannelPartialRequest UpdateChannelPartialRequest) (UpdateChannelPartialResponse, error) {
	...
	pathParams := []string{Type, Id}
	err := MakeRequest(c.client, ctx, "PATCH", "/api/v2/chat/channels/{type}/{id}", nil, &UpdateChannelPartialRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) UpdateChannel(ctx context.Context, Type string, Id string, UpdateChannelRequest UpdateChannelRequest) (UpdateChannelResponse, error) {
	...
	pathParams := []string{Type, Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/channels/{type}/{id}", nil, &UpdateChannelRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) SendEvent(ctx context.Context, Type string, Id string, SendEventRequest SendEventRequest) (EventResponse, error) {
	...
	pathParams := []string{Type, Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/channels/{type}/{id}/event", nil, &SendEventRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) DeleteFile(ctx context.Context, Type string, Id string, Url *string) (FileDeleteResponse, error) {
	...
	pathParams := []string{Type, Id}
	err := MakeRequest[any](c.client, ctx, "DELETE", "/api/v2/chat/channels/{type}/{id}/file", url.Values{"Url": []string{Url}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) UploadFile(ctx context.Context, Type string, Id string, FileUploadRequest FileUploadRequest) (FileUploadResponse, error) {
	...
	pathParams := []string{Type, Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/channels/{type}/{id}/file", nil, &FileUploadRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) HideChannel(ctx context.Context, Type string, Id string, HideChannelRequest HideChannelRequest) (HideChannelResponse, error) {
	...
	pathParams := []string{Type, Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/channels/{type}/{id}/hide", nil, &HideChannelRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) DeleteImage(ctx context.Context, Type string, Id string, Url *string) (FileDeleteResponse, error) {
	var result FileDeleteResponse
	pathParams := []string{Type, Id}
	err := MakeRequest[any](c.client, ctx, "DELETE", "/api/v2/chat/channels/{type}/{id}/image", url.Values{"Url": []string{Url}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) UploadImage(ctx context.Context, Type string, Id string, ImageUploadRequest ImageUploadRequest) (ImageUploadResponse, error) {
	...
	pathParams := []string{Type, Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/channels/{type}/{id}/image", nil, &ImageUploadRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) SendMessage(ctx context.Context, Type string, Id string, SendMessageRequest SendMessageRequest) (SendMessageResponse, error) {
	...
	pathParams := []string{Type, Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/channels/{type}/{id}/message", nil, &SendMessageRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) GetManyMessages(ctx context.Context, Type string, Id string, Ids []string) (GetManyMessagesResponse, error) {
	...
	pathParams := []string{Type, Id}
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/channels/{type}/{id}/messages", url.Values{"Ids": []string{Ids}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) GetOrCreateChannel(ctx context.Context, Type string, Id string, ChannelGetOrCreateRequest ChannelGetOrCreateRequest) (ChannelStateResponse, error) {
	var result ChannelStateResponse
	pathParams := []string{Type, Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/channels/{type}/{id}/query", nil, &ChannelGetOrCreateRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) MarkRead(ctx context.Context, Type string, Id string, MarkReadRequest MarkReadRequest) (MarkReadResponse, error) {
	var result MarkReadResponse
	pathParams := []string{Type, Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/channels/{type}/{id}/read", nil, &MarkReadRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) ShowChannel(ctx context.Context, Type string, Id string, ShowChannelRequest ShowChannelRequest) (ShowChannelResponse, error) {
	...
	pathParams := []string{Type, Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/channels/{type}/{id}/show", nil, &ShowChannelRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) TruncateChannel(ctx context.Context, Type string, Id string, TruncateChannelRequest TruncateChannelRequest) (TruncateChannelResponse, error) {
	...
	pathParams := []string{Type, Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/channels/{type}/{id}/truncate", nil, &TruncateChannelRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) MarkUnread(ctx context.Context, Type string, Id string, MarkUnreadRequest MarkUnreadRequest) (Response, error) {
	var result Response
	pathParams := []string{Type, Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/channels/{type}/{id}/unread", nil, &MarkUnreadRequest, &result, pathParams...)
	return result, err
}

func (c *ChatClient) ListChannelTypes(ctx context.Context) (ListChannelTypesResponse, error) {
	var result ListChannelTypesResponse
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/channeltypes", nil, nil, &result)
	return result, err
}
...
func (c *ChatClient) DeleteChannelType(ctx context.Context, Name string) (Response, error) {
	...
	err := MakeRequest[any](c.client, ctx, "DELETE", "/api/v2/chat/channeltypes/{name}", nil, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) GetChannelType(ctx context.Context, Name string) (Response, error) {
	var result Response
	pathParams := []string{Name}
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/channeltypes/{name}", nil, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) UpdateChannelType(ctx context.Context, Name string, UpdateChannelTypeRequest UpdateChannelTypeRequest) (UpdateChannelTypeResponse, error) {
	...
	pathParams := []string{Name}
	err := MakeRequest(c.client, ctx, "PUT", "/api/v2/chat/channeltypes/{name}", nil, &UpdateChannelTypeRequest, &result, pathParams...)
	return result, err
}

func (c *ChatClient) ListCommands(ctx context.Context) (ListCommandsResponse, error) {
	var result ListCommandsResponse
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/commands", nil, nil, &result)
	return result, err
}
...
func (c *ChatClient) DeleteCommand(ctx context.Context, Name string) (DeleteCommandResponse, error) {
	...
	pathParams := []string{Name}
	err := MakeRequest[any](c.client, ctx, "DELETE", "/api/v2/chat/commands/{name}", nil, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) GetCommand(ctx context.Context, Name string) (GetCommandResponse, error) {
	...
	pathParams := []string{Name}
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/commands/{name}", nil, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) UpdateCommand(ctx context.Context, Name string, UpdateCommandRequest UpdateCommandRequest) (UpdateCommandResponse, error) {
	...
	pathParams := []string{Name}
	err := MakeRequest(c.client, ctx, "PUT", "/api/v2/chat/commands/{name}", nil, &UpdateCommandRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) GetExportChannelsStatus(ctx context.Context, Id string) (GetExportChannelsStatusResponse, error) {
	...
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/export_channels/{id}", nil, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) QueryMembers(ctx context.Context, Payload *QueryMembersRequest) (MembersResponse, error) {
	...
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/members", url.Values{"Payload": []string{Payload}}, nil, &result)
	return result, err
}
...
func (c *ChatClient) DeleteMessage(ctx context.Context, Id string, Hard *bool, DeletedBy *string) (DeleteMessageResponse, error) {
	...
	pathParams := []string{Id}
	err := MakeRequest[any](c.client, ctx, "DELETE", "/api/v2/chat/messages/{id}", url.Values{"Hard": []string{Hard}, "DeletedBy": []string{DeletedBy}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) GetMessage(ctx context.Context, Id string, ShowDeletedMessage *bool) (GetMessageResponse, error) {
	...
	pathParams := []string{Id}
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/messages/{id}", url.Values{"ShowDeletedMessage": []string{ShowDeletedMessage}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) UpdateMessage(ctx context.Context, Id string, UpdateMessageRequest UpdateMessageRequest) (UpdateMessageResponse, error) {
	...
	pathParams := []string{Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/messages/{id}", nil, &UpdateMessageRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) UpdateMessagePartial(ctx context.Context, Id string, UpdateMessagePartialRequest UpdateMessagePartialRequest) (UpdateMessagePartialResponse, error) {
	...
	pathParams := []string{Id}
	err := MakeRequest(c.client, ctx, "PUT", "/api/v2/chat/messages/{id}", nil, &UpdateMessagePartialRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) RunMessageAction(ctx context.Context, Id string, MessageActionRequest MessageActionRequest) (MessageResponse, error) {
	...
	pathParams := []string{Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/messages/{id}/action", nil, &MessageActionRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) CommitMessage(ctx context.Context, Id string, CommitMessageRequest CommitMessageRequest) (MessageResponse, error) {
	var result MessageResponse
	pathParams := []string{Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/messages/{id}/commit", nil, &CommitMessageRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) SendReaction(ctx context.Context, Id string, SendReactionRequest SendReactionRequest) (SendReactionResponse, error) {
	...
	pathParams := []string{Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/messages/{id}/reaction", nil, &SendReactionRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) DeleteReaction(ctx context.Context, Id string, Type string, UserId *string) (ReactionRemovalResponse, error) {
	...
	pathParams := []string{Id, Type}
	err := MakeRequest[any](c.client, ctx, "DELETE", "/api/v2/chat/messages/{id}/reaction/{type}", url.Values{"UserId": []string{UserId}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) GetReactions(ctx context.Context, Id string, Limit *int, Offset *int) (GetReactionsResponse, error) {
	...
	pathParams := []string{Id}
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/messages/{id}/reactions", url.Values{"Limit": []string{Limit}, "Offset": []string{Offset}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) QueryReactions(ctx context.Context, Id string, QueryReactionsRequest QueryReactionsRequest) (QueryReactionsResponse, error) {
	...
	pathParams := []string{Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/messages/{id}/reactions", nil, &QueryReactionsRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) TranslateMessage(ctx context.Context, Id string, TranslateMessageRequest TranslateMessageRequest) (MessageResponse, error) {
	var result MessageResponse
	pathParams := []string{Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/messages/{id}/translate", nil, &TranslateMessageRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) UndeleteMessage(ctx context.Context, Id string, UpdateMessageRequest UpdateMessageRequest) (UpdateMessageResponse, error) {
	var result UpdateMessageResponse
	pathParams := []string{Id}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/messages/{id}/undelete", nil, &UpdateMessageRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) CastPollVote(ctx context.Context, MessageId string, PollId string, CastPollVoteRequest CastPollVoteRequest) (PollVoteResponse, error) {
	...
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/messages/{message_id}/polls/{poll_id}/vote", nil, &CastPollVoteRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) RemovePollVote(ctx context.Context, MessageId string, PollId string, VoteId string, UserId *string) (PollVoteResponse, error) {
	...
	err := MakeRequest[any](c.client, ctx, "DELETE", "/api/v2/chat/messages/{message_id}/polls/{poll_id}/vote/{vote_id}", url.Values{"UserId": []string{UserId}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) GetReplies(ctx context.Context, ParentId string, Limit *int, Offset *int, IdGte *string, IdGt *string, IdLte *string, IdLt *string, CreatedAtAfterOrEqual *time.Time, CreatedAtAfter *time.Time, CreatedAtBeforeOrEqual *time.Time, CreatedAtBefore *time.Time, IdAround *string, CreatedAtAround *time.Time, Sort *[]*SortParam) (GetRepliesResponse, error) {
	...
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/messages/{parent_id}/replies", url.Values{"Limit": []string{Limit}, "Offset": []string{Offset}, "IdGte": []string{IdGte}, "IdGt": []string{IdGt}, "IdLte": []string{IdLte}, "IdLt": []string{IdLt}, "CreatedAtAfterOrEqual": []string{CreatedAtAfterOrEqual}, "CreatedAtAfter": []string{CreatedAtAfter}, "CreatedAtBeforeOrEqual": []string{CreatedAtBeforeOrEqual}, "CreatedAtBefore": []string{CreatedAtBefore}, "IdAround": []string{IdAround}, "CreatedAtAround": []string{CreatedAtAround}, "Sort": []string{Sort}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) QueryMessageFlags(ctx context.Context, Payload *QueryMessageFlagsRequest) (QueryMessageFlagsResponse, error) {
	...
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/moderation/flags/message", url.Values{"Payload": []string{Payload}}, nil, &result)
	return result, err
}
...
func (c *ChatClient) DeletePoll(ctx context.Context, PollId string, UserId *string) (Response, error) {
	...
	err := MakeRequest[any](c.client, ctx, "DELETE", "/api/v2/chat/polls/{poll_id}", url.Values{"UserId": []string{UserId}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) GetPoll(ctx context.Context, PollId string, UserId *string) (PollResponse, error) {
	var result PollResponse
	pathParams := []string{PollId}
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/polls/{poll_id}", url.Values{"UserId": []string{UserId}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) UpdatePollPartial(ctx context.Context, PollId string, UpdatePollPartialRequest UpdatePollPartialRequest) (PollResponse, error) {
	var result PollResponse
	pathParams := []string{PollId}
	err := MakeRequest(c.client, ctx, "PATCH", "/api/v2/chat/polls/{poll_id}", nil, &UpdatePollPartialRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) CreatePollOption(ctx context.Context, PollId string, CreatePollOptionRequest CreatePollOptionRequest) (PollOptionResponse, error) {
	...
	pathParams := []string{PollId}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/polls/{poll_id}/options", nil, &CreatePollOptionRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) UpdatePollOption(ctx context.Context, PollId string, UpdatePollOptionRequest UpdatePollOptionRequest) (PollOptionResponse, error) {
	var result PollOptionResponse
	pathParams := []string{PollId}
	err := MakeRequest(c.client, ctx, "PUT", "/api/v2/chat/polls/{poll_id}/options", nil, &UpdatePollOptionRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) DeletePollOption(ctx context.Context, PollId string, OptionId string, UserId *string) (Response, error) {
	...
	err := MakeRequest[any](c.client, ctx, "DELETE", "/api/v2/chat/polls/{poll_id}/options/{option_id}", url.Values{"UserId": []string{UserId}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) GetPollOption(ctx context.Context, PollId string, OptionId string, UserId *string) (PollOptionResponse, error) {
	var result PollOptionResponse
	pathParams := []string{PollId, OptionId}
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/polls/{poll_id}/options/{option_id}", url.Values{"UserId": []string{UserId}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) QueryPollVotes(ctx context.Context, PollId string, UserId *string, QueryPollVotesRequest QueryPollVotesRequest) (PollVotesResponse, error) {
	...
	pathParams := []string{PollId}
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/polls/{poll_id}/votes", url.Values{"UserId": []string{UserId}}, &QueryPollVotesRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) QueryBannedUsers(ctx context.Context, Payload *QueryBannedUsersRequest) (QueryBannedUsersResponse, error) {
	...
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/query_banned_users", url.Values{"Payload": []string{Payload}}, nil, &result)
	return result, err
}

func (c *ChatClient) Search(ctx context.Context, Payload *SearchRequest) (SearchResponse, error) {
	var result SearchResponse
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/search", url.Values{"Payload": []string{Payload}}, nil, &result)
	return result, err
}
...
func (c *ChatClient) GetThread(ctx context.Context, MessageId string, ConnectionId *string, ReplyLimit *int, ParticipantLimit *int, MemberLimit *int) (GetThreadResponse, error) {
	...
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/threads/{message_id}", url.Values{"ConnectionId": []string{ConnectionId}, "ReplyLimit": []string{ReplyLimit}, "ParticipantLimit": []string{ParticipantLimit}, "MemberLimit": []string{MemberLimit}}, nil, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) UpdateThreadPartial(ctx context.Context, MessageId string, UpdateThreadPartialRequest UpdateThreadPartialRequest) (UpdateThreadPartialResponse, error) {
	...
	pathParams := []string{MessageId}
	err := MakeRequest(c.client, ctx, "PATCH", "/api/v2/chat/threads/{message_id}", nil, &UpdateThreadPartialRequest, &result, pathParams...)
	return result, err
}
...
func (c *ChatClient) UnreadCounts(ctx context.Context) (WrappedUnreadCountsResponse, error) {
	...
	err := MakeRequest[any](c.client, ctx, "GET", "/api/v2/chat/unread", nil, nil, &result)
	return result, err
}
...
func (c *ChatClient) SendUserCustomEvent(ctx context.Context, UserId string, SendUserCustomEventRequest SendUserCustomEventRequest) (Response, error) {
	...
	err := MakeRequest(c.client, ctx, "POST", "/api/v2/chat/users/{user_id}/event", nil, &SendUserCustomEventRequest, &result, pathParams...)
	return result, err
}
