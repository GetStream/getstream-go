...
// 
func (c *ChatClient) FlagReportReview(ctx context.Context, request *FlagReportReviewRequest) (*StreamResponse[FlagReportReviewResponse], error) {
	var result FlagReportReviewResponse
	res, err := MakeRequest[FlagReportReviewRequest, FlagReportReviewResponse](c.client, ctx, "PATCH", "/api/v2/chat/moderation/reports/{id}",nil,request, &result,nil)
	return res, err
}
